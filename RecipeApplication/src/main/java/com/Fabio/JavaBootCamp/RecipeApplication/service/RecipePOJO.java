...
public class RecipePOJO {
	...
	public RecipePOJO(Integer cookingMin, Boolean dairyFree, Boolean glutenFree, String inst,
			Double prepMin, Double pricePerSer, Integer readyInMin, Integer serv, Double spoon,
			String title, Boolean vegan, Boolean vegetarian) {
		
		this.cookingMinutes = cookingMin;
		this.dairyFree = dairyFree;
		this.glutenFree = glutenFree;
		this.instructions = inst;
		this.preparationMinutes = prepMin;
		this.pricePerServing = pricePerSer;
		this.readyInMinutes = readyInMin;
		this.servings = serv;
		this.spoonacularScore = spoon;
		this.title = title;
		this.vegan = vegan;
